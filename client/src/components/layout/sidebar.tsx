...
export function CustomSidebar({ onShowNotifications, onCreateReposition }: CustomSidebarProps) {
  ...
  const isAdmin = user?.area === 'admin' || user?.area === 'envios';
      ...
      <SidebarHeader className="border-b bg-[var(--jasana-sidebar-bg)]">
        <div className="flex items-center gap-3 px-2 py-2">
          ...
          <div className="flex flex-col group-data-[collapsible=icon]:hidden">
            ...
            <p className="text-xs text-muted-foreground">V10.0.0 Sep26</p>
            ...
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  className={`h-10 transition-all duration-200 hover:bg-gradient-to-r hover:from-[#8c69a5]/10 hover:to-[#504b78]/10 hover:scale-[1.02] hover:shadow-sm ${location === '/dashboard'
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  className={`h-10 transition-all duration-200 hover:bg-gradient-to-r hover:from-[#8c69a5]/10 hover:to-[#504b78]/10 hover:scale-[1.02] hover:shadow-sm group ${location === '/repositions'
                    ? 'bg-gradient-to-r from-[#8c69a5]/20 to-[#504b78]/20 text-[#8c69a5] border-r-2 border-[#8c69a5] font-medium shadow-sm'
                    : ''
                    }`}
                >
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  className={`h-10 transition-all duration-200 hover:bg-gradient-to-r hover:from-[#8c69a5]/10 hover:to-[#504b78]/10 hover:scale-[1.02] hover:shadow-sm ${location === '/agenda'
                    ? 'bg-gradient-to-r from-[#8c69a5]/20 to-[#504b78]/20 text-[#8c69a5] border-r-2 border-[#8c69a5] font-medium shadow-sm'
                    : ''
                    }`}
                >
              ...
              {user?.area === 'almacen' && (
                <SidebarMenuItem>
                  <SidebarMenuButton
                    ...
                    className={`h-10 transition-all duration-200 hover:bg-gradient-to-r hover:from-[#8c69a5]/10 hover:to-[#504b78]/10 hover:scale-[1.02] hover:shadow-sm ${location === '/almacen'
                      ? 'bg-gradient-to-r from-[#8c69a5]/20 to-[#504b78]/20 text-[#8c69a5] border-r-2 border-[#8c69a5] font-medium shadow-sm'
                      : ''
                      }`}
                  >
                ...
                <SidebarMenu>
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      ...
                      className={`h-10 transition-all duration-200 hover:bg-gradient-to-r hover:from-[#8c69a5]/10 hover:to-[#504b78]/10 hover:scale-[1.02] hover:shadow-sm group ${location === '/admin'
                        ? 'bg-gradient-to-r from-[#8c69a5]/20 to-[#504b78]/20 text-[#8c69a5] border-r-2 border-[#8c69a5] font-medium shadow-sm'
                        : ''
                        }`}
                    >
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      ...
                      className={`h-10 transition-all duration-200 hover:bg-gradient-to-r hover:from-[#8c69a5]/10 hover:to-[#504b78]/10 hover:scale-[1.02] hover:shadow-sm ${location === '/metrics'
                        ? 'bg-gradient-to-r from-[#8c69a5]/20 to-[#504b78]/20 text-[#8c69a5] border-r-2 border-[#8c69a5] font-medium shadow-sm'
                        : ''
                        }`}
                    >
...
export function SidebarWrapper({ onShowNotifications, onCreateReposition }: CustomSidebarProps) {
  return (
    <SidebarProvider defaultOpen={true}>
      <CustomSidebar onShowNotifications={onShowNotifications} onCreateReposition={onCreateReposition} />
    </SidebarProvider>
  );
}
