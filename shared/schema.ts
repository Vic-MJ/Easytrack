...
export const areaEnum = pgEnum("area", ["patronaje", "corte", "bordado", "ensamble", "plancha", "calidad", "operaciones", "admin", "almacen", "diseño", "envios", "maquilas"]);
...
export const repositionPieces = pgTable("reposition_pieces", {
  ...
  repositionProductId: integer("reposition_product_id"), // Link to specific product
  talla: text("talla").notNull(),
  cantidad: integer("cantidad").notNull(),
  unit: varchar("unit", { length: 20 }).default('piezas'), // 'piezas' | 'pares'
...
export const areas = ['patronaje', 'corte', 'bordado', 'ensamble', 'plancha', 'calidad', 'operaciones', 'envios', 'almacen', 'admin', 'diseño', 'maquilas'] as const;
export type Area = "patronaje" | "corte" | "bordado" | "ensamble" | "plancha" | "calidad" | "operaciones" | "admin" | "almacen" | "diseño" | "envios" | "maquilas";
